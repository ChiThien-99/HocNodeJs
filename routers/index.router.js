...
indexRouter.get(
  `${prefix}/filter/popularApp`,
  indexController.filterPopularApp,
);
...
indexRouter.get(
  `${prefix}/filter/priceLowHigh`,
  indexController.filterPriceLowHigh,
);
indexRouter.get(
  `${prefix}/filter/priceHighLow`,
  indexController.filterPriceHighLow,
);
indexRouter.get(
  `${prefix}/filter/funcDevice`,
  indexController.filterFuncDevice,
);
indexRouter.get(
  `${prefix}/filter/categoryblogs`,
  indexController.filterCategoryblogs,
);
